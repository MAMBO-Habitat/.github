...
* [metadata](https://github.com/MAMBO-Habitat/metadata) contains information about available data files (Drone imagery, lidar and other): a list and where to find and how to download the files.
